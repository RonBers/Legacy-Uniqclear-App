 ...
 * @author User
 */
public class editContractRental extends javax.swing.JDialog {
 Connection con = new mysqlConnection().getCon();
    /**
     * Creates new form editContractRental
     */
    public editContractRental(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        EditPromoTitle.setText("Edit Contract: Rental");
        ...
        ContractTypeLabel3.setText("Additional fee:");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(customerNameDisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void BTNSaveChanges1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNSaveChanges1ActionPerformed
        ...
        String sql="UPDATE rental_contract SET rental_contract_link='"+contractLinkDisplay.getText()+"', "
                   +"minimum_refills="+minRefillsDisplay.getValue()+", additional_fee="+discountRateDisplay.getValue()+" "
                   +"WHERE rental_contract_id="+cID+"";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editContractRental.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                editContractRental dialog = new editContractRental(new javax.swing.JFrame(), true);
